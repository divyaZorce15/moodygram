...
export default async function PropertyDetail({ params }) {
  ...
  return (
    <div className="w-full min-h-screen bg-white flex flex-col">
      ...
      {/* Image Section */}
      <div className="relative h-72 w-full overflow-hidden rounded-b-[35px]">
        ...
        {/* Gradient */}
        <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-black/20 to-transparent z-[5]" />

        {/* Back button */}
        <div className="absolute top-4 left-0 right-0 px-4 z-10">
        <Link href="/">
            <button
            className="flex items-center justify-center h-[44px] w-[44px] rounded-full bg-[#D9D9D9] border border-[#C6C6C6]"
            >
