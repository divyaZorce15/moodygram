    ...
    <>
        <div className="w-full h-screen bg-white flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto">
                {/* Image Section (STICKY FIXED) */}
                <div className="sticky top-0 z-20 relative h-72 w-full overflow-x-hidden rounded-b-[35px]">
                    {/* Slider */}
                    <div
                    ...
                    <div className="absolute top-4 left-0 right-0 px-4 z-10">
                        <Link href="/">
                            <button className="flex items-center justify-center h-[44px] w-[44px] rounded-full bg-[#D9D9D9]/80 backdrop-blur border border-[#C6C6C6]">
            ...
            {/* Bottom Price Section (STICKY FIXED) */}
            <div className="p-4 border-t flex items-center justify-between sticky bottom-0 bg-white z-20 shadow-md">
                ...
                <button className="bg-green-700 text-white px-5 py-2 rounded-full text-sm font-medium" onClick={() => setShowCalendar(true)}>
                    Check Availability
                </button>
            </div>
